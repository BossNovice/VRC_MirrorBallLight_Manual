...
- 理由詳細: 開発環境からVRChat実機・ClientSim・Play Modeを実行できません。判定ロジックは
  ライセンス不要の自動テストで確認していますが、実ネットワーク遅延下での体感は確認できません。
- 期限: 2026-09-30
- 担当: @BossNovice
- 追跡: [本体リポジトリ Issue #23](https://github.com/BossNovice/VRC_MirrorBallLight/issues/23)（非公開）
- 次アクション: [実機スモーク確認](実機スモーク確認.md) の4ケースを実施し、この表を更新する
- 更新日: 2026-08-23
- 延長回数: 0

**未実施**: コンパイル確認（連携パッケージ未導入の構成）
- 理由種別: ENV_UNAVAILABLE
- 理由詳細: LTCGI・VRCLightVolumesを導入していないUnityプロジェクトが手元にありません。
- 期限: 2026-09-30
- 担当: @BossNovice
- 次アクション: 未導入構成の検証用プロジェクトを用意する
- 更新日: 2026-08-23
- 延長回数: 0
