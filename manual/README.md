...
| --- | --- | --- | --- | --- | --- |
| R29.4.2 | 2022.3.22f1 | 2.1.3 | 1.7.2 | 済 | 未実施（注8） |
| R29.4.2 | 2022.3.22f1 | 3.0.0-dev.15 | 1.7.3 | 済（注1） | 未実施（注8） |
| R29.4.2 | 2022.3.22f1 | 未導入 | 未導入 | 済（注2） | 未実施（注8） |
...
- **注8**: R29.4.2 の実機目視は行っていません。

**未実施**: R29.4.2 の実機目視（PC）
- 追跡ID: R29.4.2-UNEXEC-01
- 理由種別: ENV_UNAVAILABLE
- 理由詳細: VRChatクライアントを起動して目視する環境が用意できていません。
  この版の変更は同梱サンプルのTexture Import設定（Wrap Mode）1点だけで、
  Shader・スクリプト・Prefab・Materialには変更がありません。Unityバッチモードで
  TextureImporter が Clamp を返すことは確認しています。
- 期限: 2026-09-30
- 担当: リポジトリ所有者
- 次アクション: VRChat（PC）で設定済みサンプルを開き、光点の形が従来どおり出ることを目視する。
  確認できたら表を「済」へ更新し、このブロックを削除する
- 更新日: 2026-08-28
- 延長回数: 0
