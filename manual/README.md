...
| --- | --- | --- | --- | --- | --- |
| R29.4.1 | 2022.3.22f1 | 2.1.3 | 1.7.2 | 済 | 済（注7） |
| R29.4.1 | 2022.3.22f1 | 3.0.0-dev.15 | 1.7.3 | 済（注1） | 済（注7） |
| R29.4.1 | 2022.3.22f1 | 未導入 | 未導入 | 済（注2） | 済（注7） |
...
- **注7**: R29.4.1 の実機目視で問題は見つかりませんでした。**代表的なシーンの目視であり、
  全機能を網羅した確認ではありません**（上の凡例のとおりです）。R29.4.1 で変わったのは
  `電源の範囲`＝ローカルのときの経路だけで、その経路はUdonを実際に走らせる検査
  （ClientSim）でも確認しています。
