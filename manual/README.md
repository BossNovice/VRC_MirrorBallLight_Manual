...
- **注27**: R30.15で、**R30.9〜R30.14で省いていた検査をまとめて回収しました。**
  ...
  速度10度/秒）。**ただし、2人以上でのプリセット切替の伝播だけは未確認です**
  （R30.15-UNEXEC-01）。R30.15自体は診断ログを消しただけで、描画も既定の動作も
  変えていません。
...
**未実施**: 2人以上のワールドで、所有者でない人のプリセット切替が全員へ伝わるかの確認
...
- 期限: 2026-09-11
- 担当: 利用者とリリース担当
- 次アクション: 2人以上でワールドへ入り、ワールドの所有者でない人がプリセットを
  切り替えたとき全員に反映され、直後に回転が飛んだり止まったりしないことを確認する
- 引き継ぎ元: R30.8-UNEXEC-01 の (5)
- 更新日: 2026-09-04
- 延長回数: 0
