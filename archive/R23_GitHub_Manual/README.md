...
Global共有はScene内で1系統です。異なる設定のControllerを複数同時に使用する場合、主Controller以外はGlobal共有をOFFにしてください。旧R22.1の最適化図解は [`archive/MirrorBallLightController_R22.1_最適化マニュアル.md`](../MirrorBallLightController_R22.1_最適化マニュアル.md) に保存しています。
