...
VRChat World向け `VRC_MirrorBallLight` のマニュアル専用リポジトリです。現在の対応バージョンは **R26.1** です。

## 現行マニュアル

- [GitHub版・導入から全設定まで](R26/README.md)
